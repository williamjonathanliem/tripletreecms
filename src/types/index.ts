export type Subject = 'coding' | 'chinese' | 'english' | 'maths' | 'science' | 'calligraphy' | 'arts' | 'chinese_extra'

export const SUBJECTS: Subject[] = ['coding', 'chinese', 'chinese_extra', 'english', 'maths', 'science', 'calligraphy', 'arts']
...
export const SUBJECT_META: Record<Subject, { label: string; color: string; bg: string }> = {
  ...
  chinese_extra:{ label: 'Chinese (Extra)',   color: '#922B21', bg: '#FCEAEA' },
  english:      { label: 'English',           color: '#7D6608', bg: '#FDFBEC' },
  maths:        { label: 'Maths',             color: '#1E8449', bg: '#EAF3DE' },
  science:      { label: 'Science',           color: '#117A65', bg: '#E8F8F5' },
  calligraphy:  { label: 'Calligraphy',       color: '#4A235A', bg: '#F3E5F5' },
  arts:         { label: 'Arts & Craft',      color: '#E65100', bg: '#FFF3E0' },
}
